...
class UnityOutputCalculator : public CalculatorBase {
 public:
  ...
  friend void OutputCalculator_SetCallbacks(on_open_t, on_process_t, on_close_t, get_image_frame_t);
...
on_open_t UnityOutputCalculator::OnOpen = nullptr;
on_process_t UnityOutputCalculator::OnProcess = nullptr;
on_close_t UnityOutputCalculator::OnClose = nullptr;
get_image_frame_t UnityOutputCalculator::GetImageFrame = nullptr;

void OutputCalculator_SetCallbacks(on_open_t onOpen, on_process_t onProcess, on_close_t onClose, get_image_frame_t getImageFrame)
{
    UnityOutputCalculator::OnOpen = onOpen;
    UnityOutputCalculator::OnProcess = onProcess;
    UnityOutputCalculator::OnClose = onClose;
    UnityOutputCalculator::GetImageFrame = getImageFrame;
}

EXPORT(void) UnityMediaPipe_OutputCalculator_SetCallbacks(on_open_t onOpen, on_process_t onProcess, on_close_t onClose, get_image_frame_t getImageFrame)
{
    OutputCalculator_SetCallbacks(onOpen, onProcess, onClose, getImageFrame);
}
