...
EXPORT(void) UnityMediaPipe_VideoCalculator_SetCallbacks(on_open_t onOpen, on_process_t onProcess, on_close_t onClose)
{
  VideoCalculator_SetCallbacks(onOpen, onProcess, onClose);
}
